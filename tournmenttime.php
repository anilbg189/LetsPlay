...
<div class="process" align="left">
  ...
  <div align="left" class="container">
    <label class="content" for="tournmenttime"><b>Select a time</b></label>
    <input type="time" class="content" placeholder="Enter tournment time" name="tournmenttime" required>
