  ...
  <div class="rightarrow">&#8658</div>
   ...
   <div class="rightarrow">&#8658</div>
    ...
    <div class="rightarrow">&#8658</div>
     ...
     <div class="rightarrow">&#8658</div>
     <div class="processcontents" >Prize</div>
      <div class="rightarrow">&#8658</div>
      <div class="processcontents" >Confirm</div>
 </div>

  <div align="left" class="container">
    <label class="content" for="tournmentdate"><b>Select a Date : </b></label>
    <input type="date" class="content" placeholder="Enter tournment date" name="tournmentdate" required>
